...
contract Agrowchain {
    ...
    // --- DECENRALIZED REPUTATION SYSTEM ---
    ...
    // 2. ESCROW: Retailer buys the batch and locks funds in the contract
    ...
    // 3. Distributor moves the package
    ...
    // 4. REPUTATION + PAYOUT: Delivery completed successfully
    function completeDelivery(uint256 _id) public {
        ...
        batch.isFunded = false; // Prevent re-entrancy attacks
        batch.farmer.transfer(payout);

        // Boost Farmer's Trust Score (Reputation)
